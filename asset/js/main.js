$(document).ready(function () {
  $('#side-icon').click(function (e) {
    ...
    if ($(this).hasClass('active')) {
      $('#side-icon').removeClass("active r-180");
      $("aside").removeClass('w-0');
      $("aside").removeClass('aside-hover');
      $(".menu-arrow").removeClass("d-n");
      $(".menu-title").removeClass("d-n");
      $(".heading").removeClass("d-n");
      $("main").removeClass("move");
      $(".aside-footer").removeClass("d-n");
      $(".logo1").show();
      $(".logo2").hide();
    } else {
      $('#side-icon').addClass("active r-180");
      $("aside").addClass('w-0');
      $("aside").addClass('aside-hover');
      $(".menu-arrow").addClass("d-n");
      $(".menu-title").addClass("d-n");
      $(".heading").addClass("d-n");
      $("main").addClass("move");
      $(".aside-footer").addClass("d-n");
      $(".logo1").hide();
      $(".logo2").show();
    }
  });

$(".logo2").click(function(e){
  ...
  $('.btn-Customize').click(function () {
    $('.Customize-wrapper').animate({"right":"0"}, "slow").show();
  });

  $('#btncloseCustomize').click(function () {
    $('.Customize-wrapper').animate({"right":"-1000px"}, "slow");
    setTimeout(function(){
      $('.Customize-wrapper').hide();
    },1000);
  ...
  $('.menu-link').click(function () {
    $('.menu-sub').not($(this).next('.menu-sub')).hide(500);
    $('.menu-arrow').not($(this).find('.menu-arrow')).removeClass("r-180");
    $(this).next('.menu-sub').slideToggle(500);
    $(this).find('.menu-arrow').toggleClass("r-180");
  ...
  var data = { series: [[12, 8, 12, 10, 10, 19, 2, 10, 9, 4, 11, 15, 7]] }
  new Chartist.Line('.ct-chart1', data, sparkOptions);
  var data = { series: [[5, 8, 12, 14, 10, 19, 13, 10, 9, 5, 11, 5, 3]] }
  new Chartist.Line('.ct-chart2', data, sparkOptions);
  var data = { series: [[5, 8, 12, 14, 10, 19, 13, 10, 9, 5, 11, 5, 3]] }
  new Chartist.Line('.ct-chart3', data, sparkOptions);
  var data = { series: [[1, 8, 17, 14, 1, 19, 13, 1, 9, 5, 15, 5, 10]] }
  new Chartist.Line('.ct-chart4', data, sparkOptions);
  var data = { series: [[5, 12, 2, 6, 10, 4, 13, 10, 19, 5, 1, 5, 13]] }
  new Chartist.Line('.ct-chart5', data, sparkOptions);
  var data = { series: [[5, 12, 2, 6, 10, 4, 13, 10, 19, 5, 1, 5, 13]] }
  new Chartist.Line('.ct-chart6', data, sparkOptions);
  var data = { series: [[5, 8, 12, 14, 10, 19, 13, 10, 9, 5, 11, 5, 3]] }
  new Chartist.Line('.ct-chart7', data, sparkOptions);
  var data = { series: [[5, 8, 12, 14, 10, 19, 13, 10, 9, 5, 11, 5, 3]] }
  new Chartist.Line('.ct-chart8', data, sparkOptions);
  var data = { series: [[5, 12, 2, 6, 10, 4, 13, 10, 19, 5, 1, 5, 13]] }
  new Chartist.Line('.ct-chart9', data, sparkOptions);
...
var KTCardsWidget17 = function () {
  ...
  var initChart = function () {
    ...
    drawCircle('#009ef7', options.lineWidth, 100 / 150);
    drawCircle('#50cd89', options.lineWidth, 100 / 250);
  }
